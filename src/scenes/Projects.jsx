...
const works = [
  {
    ...
    description:
      "Expense Tracker is a user-friendly app that helps you track your expenses and income. It alerts you when your expenses surpass your balance, and rewards you when you are effectively managing your finances.",
    language: ["MongoDB", "Express", "React.Js"],
    liveLink: "https://expense-tracker-ochre-ten.vercel.app/",
...

  {
    ...
    liveLink: "https://wonderful-youtiao-11d2e0.netlify.app/",
...

  {
    ...
    liveLink: "https://space-x-project1.netlify.app/",
