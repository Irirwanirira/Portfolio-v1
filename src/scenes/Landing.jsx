        ...
        <section id='home' className="flex justify-start items-start md:justify-between md:items-center gap-16 py-10">
            ...
            <div className="z-30 mt-12 md:mt-32">
                ...
                >
                    ...
                    <p className="text-4xl font-playfair z-10 text-center md:text-start mb-4">
                        Hi, I'm {""}
                        <span
                        className="text-6xl font-playfair z-10 text-center md:text-start text-green"
                        >
                                Joseph
                            
                        </span>
                    </p>
                    <h2 className='font-playfair font-semibold text-4xl sm:text-7xl'>
                        I'm a Full Stack Developer.
                    </h2>
                    <p className="mt-10 mb-7 text-sm text-center md:text-start w-[70%]">
